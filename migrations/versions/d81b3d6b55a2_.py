...
Revision ID: d81b3d6b55a2
Revises: 69811212b0c7
Create Date: 2020-08-24 15:15:06.947136
...
revision = 'd81b3d6b55a2'
down_revision = '69811212b0c7'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.add_column('tipo_urgencia', sa.Column('urgencia', sa.Enum('EMBARAZO', 'ACCIDENTE', 'RESPIRATORIO', 'OTRO', name='urgenciaenum'), nullable=True))
